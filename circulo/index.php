    <?php
        ...
        $quadro = new Quadro('','', $circulo);
        
        $id = isset($_GET['id'])?$_GET['id']:0;
        if ($id > 0){
            $dados = $circulo->listar(1,$id);
            $qeditando = new Circulo($dados[0]['id'],$dados[0]['lado'],$dados[0]['cor'],$dados[0]['un'], $dados[0]['quadro']);
        }
    ?>
    <style>
        .desenho{
    ...
    <div class="row">
        ...
        <label for="id">Id:</label>
                ...
                <input type="color" name='cor' id='cor' value='<?php  if(isset($qeditando)) echo $qeditando->getCor(); ?>'>
        ...
        <?php
            ...
            foreach($lista as $item){
                $q = new Circulo($item['id'],$item['lado'],$item['cor'],$item['un'], $item['quadro']);

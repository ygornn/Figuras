...
if ($id > 0){
    ...
    $qeditando = new Retangulo($dados[0]['id'],$dados[0]['lado'],$dados[0]['lado2'],$dados[0]['cor'],$dados[0]['un'], $dados[0]['quadro']);
}
?>
    <style>
        .desenho{
    ...
    <?php
        ...
        foreach($lista as $item){
            $q = new Retangulo($item['id'],$item['lado'],$item['lado2'],$item['cor'],$item['un'],$item['quadro']);
